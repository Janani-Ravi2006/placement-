...
export default function AlumniFeedbackForm() {
          ...
          <div className="bg-blue-50/80 backdrop-blur-xl border-l-4 border-blue-500 rounded-r-2xl p-5 shadow-lg">
            <div className="flex items-start gap-4">
              ...
              <p className="text-blue-900 text-sm font-medium leading-relaxed">
                Please provide honest and constructive feedback to help the applicant grow. Include strengths, areas for improvement, and specific recommendations.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-purple-100 p-8 sm:p-12">
            <div className="space-y-6">
              ...
              {/* Robot Checkbox */}
              <div className="flex items-center gap-3 bg-purple-50/50 backdrop-blur-sm p-5 rounded-2xl border-2 border-purple-100 hover:bg-purple-50/70 transition-all duration-300 cursor-pointer">
                <input
                  type="checkbox"
                  name="isRobot"
                  id="isRobot"
                ...
                />
                <label htmlFor="isRobot" className="text-sm font-semibold text-gray-900 cursor-pointer select-none">
                  I'm not a robot
                </label>
              </div>
